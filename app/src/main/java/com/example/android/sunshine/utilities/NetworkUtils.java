...
public final class NetworkUtils {
    ...
    public static URL getUrl(Context context) {
        if (SunshinePreferences.isLocationLatLonAvailable(context)) {
            ...
            double preferredLatitude = preferredCoordinates[0];
            double preferredLongitude = preferredCoordinates[1];
            return buildUrlWithLatitudeLongitude(preferredLatitude, preferredLongitude);
        } else {
            String query = SunshinePreferences.getPreferredWeatherLocation(context);
            return buildUrlWithLocationQuery(query);
        }
    }
